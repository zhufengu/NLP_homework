...
print()
A = predict_nationality("McMahan", classifier, vectorizer)
print(f"姓氏：{A['surname']}，国籍：{A['nationality']}，概率置信度：{A['probability']}")
B = predict_nationality("Nakamoto", classifier, vectorizer)
print(f"姓氏：{B['surname']}，国籍：{B['nationality']}，概率置信度：{B['probability']}")
C = predict_nationality("Wan", classifier, vectorizer)
print(f"姓氏：{C['surname']}，国籍：{C['nationality']}，概率置信度：{C['probability']}")
D = predict_nationality("Cho", classifier, vectorizer)
print(f"姓氏：{D['surname']}，国籍：{D['nationality']}，概率置信度：{D['probability']}")
